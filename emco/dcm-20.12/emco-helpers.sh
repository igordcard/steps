...
curl -X POST "$clm/cluster-providers/cp/clusters" -F "metadata=$c1data" -F "file=@c1.config"
curl -X POST "$clm/cluster-providers/cp/clusters" -F "metadata=$c3data" -F "file=@c3.config"
